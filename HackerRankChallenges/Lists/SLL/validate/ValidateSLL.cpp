...
//            slow and slow->next and fast and fast->next and fast->next->next;
...
//        if (not HasCycle(head)) return 0;
//        std::unordered_map<uintptr_t, int> a;
//        SinglyLinkedListNode* prev = nullptr;
//        int counter = 0;
//        while (head) {
//            if (a[reinterpret_cast<uintptr_t>(head)] > 0) {
//                return (a[reinterpret_cast<uintptr_t>(prev)] - a[reinterpret_cast<uintptr_t>(head)]) + 1;
//            }
//            a[reinterpret_cast<uintptr_t>(head)] = counter++;
//            prev = head;
//            head = head->next;
//        }
//        return 0;
...
//        if (not HasCycle(head)) return nullptr;
//        std::unordered_map<uintptr_t, int> a;
//        SinglyLinkedListNode* prev = nullptr;
//        int counter = 1;
//        while (head) {
...
//        if (not HasCycle(head)) return head;
//        SinglyLinkedListNode* target = GetCycleEndNode(head);
//        target->next = nullptr;
//        return head;
//    }
//
//    void SplitCycle(SinglyLinkedListNode* head, SinglyLinkedListNode** head1_ref, SinglyLinkedListNode** head2_ref) {
//        if (not HasCycle(head)) return;
//        (*head1_ref) = head;
//        SinglyLinkedListNode* target = GetCycleEndNode(head);
//
...
//        }
//
//        (*head2_ref) = target->next;
//        target->next = nullptr;
//
//        while (head and head->next != (*head2_ref)) {
//            head = head->next;
//        }
